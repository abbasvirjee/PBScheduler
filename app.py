...
def generate_fixtures(player_names, game_count):
    ...
    # Loop until we find valid games that maintain fairness
    while True:
        ...
        fixtures.append({"game_number": game_number, "teams": [team1, team2]})
        ...
        # Stop generating games if all players have equal games
